...
namespace Drupal\islandora_rdm_multifile_media\Plugin\ContextReaction;

use Drupal\Core\Entity\EntityInterface;
use Drupal\Core\Form\FormStateInterface;
use Drupal\islandora_rdm_multifile_media\Plugin\Action\AbstractGenerateDerivativeMediaFile;
 ...
 * @ContextReaction(
 *   id = "file_derivative",
 *   label = @Translation("Derive file For Existing RDM Media")
 * )
 */
